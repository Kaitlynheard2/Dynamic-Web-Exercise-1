...
function Article() {
    //can change the value of article
    ...
    return (
        <main>
            <section className = "ArticleHeader" style= {{backgroundImage: `url('${article.image && article.image.url}')`, backgroundSize:"cover", backgroundPosition:"center"}}>
